              ...
              <div className="bg-green-50 dark:bg-green-950/30 border border-green-200 dark:border-green-800 rounded-lg p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <h4 className="font-medium text-green-900 dark:text-green-300">Exportação Concluída</h4>
            ...
            {exportStatus?.status === "pending" && (
              <div className="bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-medium text-blue-900 dark:text-blue-300">Processando Exportação</h4>
        ...
        <Card className="border-red-200 dark:border-red-800">
          <CardHeader>
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-red-900 dark:text-red-300">Excluir Conta</CardTitle>
            </div>
            <CardDescription>
            ...
            {deletionStatus?.status === "pending" && (
              <div className="bg-yellow-50 dark:bg-yellow-950/30 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-medium text-yellow-900 dark:text-yellow-300">Aguardando Confirmação</h4>
