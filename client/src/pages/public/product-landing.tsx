          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-20">
              ...
              >
                <motion.div
                  variants={fadeInUp}
                  className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 text-primary text-xs sm:text-sm font-medium mb-4 md:mb-6 border border-primary/20"
                >
                ...
                >
                  ...
                  <Button
                    variant="outline"
                    size="lg"
                    className="h-12 md:h-14 px-6 md:px-8 text-base md:text-lg rounded-full hover:bg-secondary/50 backdrop-blur-sm border-2"
                ...
                <motion.div
                  variants={fadeInUp}
                  className="mt-6 md:mt-10 flex items-center justify-center lg:justify-start gap-4 text-xs sm:text-sm text-muted-foreground"
                >
              ...
              <motion.div
                className="w-full max-w-sm sm:max-w-xl lg:max-w-none lg:w-1/2 relative"
                initial={{ opacity: 0, x: 50 }}
                animate={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.8, delay: 0.2 }}
              >
                <div className="relative z-10 rounded-xl md:rounded-2xl border bg-background/50 backdrop-blur-xl shadow-2xl overflow-hidden group hover:scale-[1.02] transition-transform duration-500">
