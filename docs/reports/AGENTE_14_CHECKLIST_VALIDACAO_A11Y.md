...
<OptimizedImage src="photo.jpg" alt="Descrição da imagem" />
```
...
- **axe Violations:** Críticas: **_ | Sérias: _** | Moderadas: **_ | Menores: _**
