...
```tsx
<a href="/properties/123">Ver detalhes do imóvel Casa no Centro</a>
```

❌ **INCORRETO:**

```tsx
<a href="/properties/123">Clique aqui {/* Não descritivo */}</a>
```
...
function Modal({ isOpen, onClose }) {
  ...
  return <div ref={containerRef}>{/* Conteúdo do modal */}</div>;
}
```
