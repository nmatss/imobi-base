...
>
  ...
  {notificationCount > 0 && (
    <span className="absolute -top-0.5 -right-0.5...">{notificationCount}</span>
  )}
</Button>
```
...
_Relatório gerado pelo AGENTE 6 - ACESSIBILIDADE_
_ImobiBase - Sistema de Gestão Imobiliária_
